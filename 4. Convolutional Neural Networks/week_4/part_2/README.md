...
```
    ...
    <matplotlib.image.AxesImage at 0x7f52eb759438>
...
def compute_content_cost(a_C, a_G):
    ...
    a_C_unrolled = tf.reshape(a_C,[n_H * n_W, -1])
    a_G_unrolled = tf.reshape(a_G,[n_H * n_W, -1])
...
```
    ...
    <matplotlib.image.AxesImage at 0x7f52e865def0>
...
def compute_layer_style_cost(a_S, a_G):
    ...
    a_S = tf.reshape(a_S,[n_H * n_W, -1])
    a_G = tf.reshape(a_G,[n_H * n_W, -1])
...
```
    ...
    <matplotlib.image.AxesImage at 0x7f52e8587400>
